...
cap = cv2.VideoCapture('RIghtServeView.mp4')
...
out = cv2.VideoWriter('serve_pose_skeleton_output_blackbg.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (frame_width, frame_height))
